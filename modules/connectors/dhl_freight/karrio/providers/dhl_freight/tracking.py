"""Karrio DHL Freight tracking API implementation."""
...
import karrio.schemas.dhl_freight.tracking_request as dhl_freight_req
import karrio.schemas.dhl_freight.tracking_response as dhl_freight_res
...
def _extract_details(
    ...
    tracking_details = lib.to_object(dhl_freight_res.TrackingResponseType, data)
...
def tracking_request(
    ...
    request = dhl_freight_req.TrackingRequestType(
        trackingInfo={
