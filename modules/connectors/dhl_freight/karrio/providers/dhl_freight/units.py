...
class ShippingService(lib.StrEnum):
    ...
    dhl_freight_standard_service = "DHL Freight Standard Service"


class ShippingOption(lib.Enum):
    """ Carrier specific options """
    # dhl_freight_option = lib.OptionEnum("code")

    """ Unified Option type mapping """
    # insurance = dhl_freight_coverage  #  maps unified karrio option to carrier specific
