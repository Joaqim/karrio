...
@attr.s(auto_attribs=True)
class NumberOfPackageTypeCodeItemsType:
...
class GoodsItemType:
    ...
    numberOfPackageTypeCodeItems: typing.Optional[NumberOfPackageTypeCodeItemsType] = jstruct.JStruct[NumberOfPackageTypeCodeItemsType]
