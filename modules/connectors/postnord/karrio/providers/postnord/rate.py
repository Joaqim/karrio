...
import karrio.schemas.postnord.rate_request as postnord_req
import karrio.schemas.postnord.rate_response as postnord_res
...
def _extract_details(
    ...
    rate = lib.to_object(postnord_res.RateResponseType, data)
...
def rate_request(
    ...
    request = postnord_req.RateRequestType(
        # Map shipper details
        shipper={
