...
class ShippingService(lib.StrEnum):
    ...
    postnord_standard_service = "PostNord Standard Service"


class ShippingOption(lib.Enum):
    """ Carrier specific options """
    # postnord_option = lib.OptionEnum("code")

    """ Unified Option type mapping """
    # insurance = postnord_coverage  #  maps unified karrio option to carrier specific
